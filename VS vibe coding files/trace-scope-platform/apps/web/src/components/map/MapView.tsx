...
export function MapView({
  ...
  return (
    <div className="panel" style={{ minHeight: '420px', padding: '24px', display: 'grid', gap: '16px' }}>
      <div>
      ...
      <div ref={containerRef} style={{ minHeight: '320px', borderRadius: '20px', overflow: 'hidden', background: 'linear-gradient(135deg, rgba(114, 227, 210, 0.10), rgba(8, 16, 25, 0.95))', border: '1px solid var(--panel-border)' }} />
