...
export interface MediaImage { id: string; mediaSetId: string; url: string; thumbnailUrl: string; altText: string; caption: string; sortOrder: number; createdAt: string; }
